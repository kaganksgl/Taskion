...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      var t1,
        menuButton = A._asJSObjectQ(A._asJSObject(init.G.document).querySelector("#menuButton"));
      if (menuButton != null) {
        t1 = type$._ElementEventStreamImpl_JSObject;
        A._EventStreamSubscription$(menuButton, "click", t1._eval$1("~(1)?")._as(new A.main_closure()), false, t1._precomputed1);
      }
    },
  ...
  A.main_closure.prototype = {
    call$1($event) {
      A._asJSObject(init.G.window).alert("Yeni nesil Dart ile pop-up!");
    },
    $signature: 4
  };
  (function aliases() {
